<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wwwroot\zjce\wwwroot\public/../application/admin\view\cate\edit.htm";i:1587209231;s:71:"D:\wwwroot\zjce\wwwroot\public/../application/admin\view\public\top.htm";i:1587180085;s:72:"D:\wwwroot\zjce\wwwroot\public/../application/admin\view\public\left.htm";i:1587180085;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="radio" style="float:left; margin-right:10px;">
                                    <label>
                                        <input <?php if($cates['type'] == 4): ?>checked="checked"<?php endif; ?> name="type" class="inverted" value="4" type="radio">
                                        <span class="text">资料列表</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left; margin-right:10px;">
                                    <label>
                                        <input <?php if($cates['type'] == 3): ?>checked="checked"<?php endif; ?> name="type" class="inverted" value="3" type="radio">
                                        <span class="text">其它单页</span>
                                    </label>
                                </div>
                            </div>
                        </div> 
