<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wwwroot\zjce\wwwroot\public/../application/admin\view\news\edit.htm";i:1589627551;s:71:"D:\wwwroot\zjce\wwwroot\public/../application/admin\view\public\top.htm";i:1587180085;s:72:"D:\wwwroot\zjce\wwwroot\public/../application/admin\view\public\left.htm";i:1587180085;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data" >
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="title"  value="<?php echo $olddata['title']; ?>" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="author"  type="text" value="<?php echo $olddata['author']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="thumb"  type="text" value="<?php echo $olddata['thumb']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="desc"  type="text" value="<?php echo $olddata['desc']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label style="margin-right:15px;">
                                    <input <?php if(($olddata["click"]==0)): ?>checked="checked"<?php endif; ?> name="click" value="0" type="radio">
                                    <span class="text">通知</span>
                                </label>
                                <label style="margin-right:15px;">
                                    <input <?php if(($olddata["click"]==1)): ?>checked="checked"<?php endif; ?> class="inverted" name="click" value="1" type="radio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label style="margin-right:15px;">
                                    <input <?php if(($olddata["rec"]=="1")): ?>checked="checked"<?php endif; ?> name="rec" value="1" type="radio">
                                    <span class="text">是</span>
                                </label>
                                <label style="margin-right:15px;">
                                    <input <?php if(($olddata["rec"]=="0")): ?>checked="checked"<?php endif; ?> class="inverted" name="rec" value="0" type="radio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea id="content" name="content"><?php echo $olddata['content']; ?></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
