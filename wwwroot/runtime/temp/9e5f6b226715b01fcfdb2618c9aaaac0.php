<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\wwwroot\zjce\wwwroot\public/../application/admin\view\article\lst.htm";i:1586940066;s:71:"D:\wwwroot\zjce\wwwroot\public/../application/admin\view\public\top.htm";i:1586940073;s:72:"D:\wwwroot\zjce\wwwroot\public/../application/admin\view\public\left.htm";i:1587164773;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<body>
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            <a href="#" class="menu-dropdown">
                <i class="menu-icon fa fa-file-text"></i>
                <span class="menu-text">新闻通知</span>
                <i class="menu-expand"></i>
            </a>
            <ul class="submenu">
                <li>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <img src="<?php echo $art['thumb']; ?>" height="20">
